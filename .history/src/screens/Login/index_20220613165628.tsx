                ...
                >
                    ...
                    {({handleChange, handleSubmit, isSubmitting}) => (
                        <View>
                            ...
                            <Button buttonStyle={{backgroundColor:'#800000', marginHorizontal: 10, borderRadius: 30}} type='clear' onPress={() => handleSubmit()} color: '#fff' title="Cadastrar" disabled={isSubmitting} />
                        </View>
                        )}
