...
const cadastrar = async (usuario) => {
 ...
 function handleLogin(){
  ...
  signInWithEmailAndPassword(auth, email, senha)
    ...
    .catch(error => console.log('O campo Email ou Senha, precisa ser preenchido!') ToastAndroid.show('O campo Email ou Senha, precisa ser preenchido!', ToastAndroid.LONG))
