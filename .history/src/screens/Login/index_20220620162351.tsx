  ...
  <ImageBackground source={bg} style={styles.Background}>
    <Formik 
      ...
      validationSchema={Yup.object({
        ...
        senha: Yup.string().required('Informe a senha').min(6, 'A senha precisa de 6 caracteres'ToastAndroid.show('O campo Email ou Senha, precisa ser preenchido!', ToastAndroid.LONG))
      })}
