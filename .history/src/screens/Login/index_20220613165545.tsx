                ...
                >
                    ...
                    {({handleChange, handleSubmit, isSubmitting}) => (
                        <View>
                            ...
                            <Button buttonStyle={{backgroundColor:'#800000', marginHorizontal: 10, borderRadius: 30, color: '#fff'}} type='clear' onPress={() => handleSubmit()} title="Cadastrar" disabled={isSubmitting} />
                        </View>
                        )}
